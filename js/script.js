// === БАЗА ДАННЫХ УРОКОВ С ПОДРОБНЫМИ ОБЪЯСНЕНИЯМИ ===
const lessons = [
    // ================= HTML =================
    {
...
&lt;a href="..." target="_blank"&gt;Новая вкладка&lt;/a&gt;</pre>
            ...
            <ul>
                ...
                <li><strong>alt</strong>: альтернативный текст (если картинка не загрузится или для слепых).</li>
            </ul>`
    },
    {
...
&lt;/style&gt;</pre>
            ...
            <p>Напрямую в теге (плохая практика):</p>
...
#header { height: 60px; }</pre>
  ...
  margin: 30px;     <span style="color:#636e72">/* Отступ снаружи, от других элементов */</span>
            ...
            <p>Совет: используйте <code>box-sizing: border-box;</code>, чтобы padding не увеличивал ширину элемента.</p>`
    },
    {
  ...
  justify-content: center; <span style="color:#636e72">/* По горизонтали (start, end, space-between) */</span>
  ...
  gap: 10px;               <span style="color:#636e72">/* Расстояние между элементами */</span>
            ...
            <p>Это идеально подходит для навигационных меню и центрирования блоков.</p>`
    },
    {
...
const pi = 3.14;
pi = 3.15; <span style="color:#636e72">// ОШИБКА!</span>
...
console.log(fruits.length); <span style="color:#636e72">// 4</span></pre>
            ...
            <p>Массивы часто перебирают циклами (forEach, map).</p>`
    },
    {
...
// Запуск редактора при загрузке
window.onload = runCode;

// === ТЕСТ (QUIZ) - РАСШИРЕННЫЙ ===
const questions = [
    {
        q: "Какой тег делает текст жирным?",
        opts: ["&lt;b&gt;", "&lt;bold&gt;", "&lt;br&gt;"],
        correct: 0,
        info: "Тег &lt;b&gt; или &lt;strong&gt; делает текст жирным."
    },
    {
        q: "Как изменить цвет текста в CSS?",
        opts: ["text-color: red;", "color: red;", "font-color: red;"],
        correct: 1,
        info: "Свойство 'color' отвечает за цвет текста."
    },
    {
        q: "Как объявить переменную в JS?",
        opts: ["var myVar;", "variable myVar;", "int myVar;"],
        correct: 0,
        info: "Используйте let, const или (старое) var."
    },
    {
        q: "Что выведет console.log(2 + '2')?",
        opts: ["4", "22", "Ошибка"],
        correct: 1,
        info: "JS склеит число и строку: '22'."
    },
    {
        q: "Какой символ используется для ID в CSS?",
        opts: [". (точка)", "# (решетка)", "@ (собака)"],
        correct: 1,
        info: "#id { ... } используется для идентификаторов."
    },
    {
        q: "Какой атрибут у ссылки открывает её в новой вкладке?",
        opts: ["target='_self'", "target='_blank'", "new='true'"],
        correct: 1,
        info: "target='_blank' открывает ссылку в новой вкладке."
    },
    {
        q: "Что означает padding в CSS?",
        opts: ["Внешний отступ", "Внутренний отступ", "Граница элемента"],
        correct: 1,
        info: "Padding — это внутренний отступ между контентом и границей."
    },
    {
        q: "Какое свойство CSS включает Flexbox?",
        opts: ["position: flex", "display: flex", "flex: true"],
        correct: 1,
        info: "display: flex активирует flexbox-контейнер."
    },
    {
        q: "С какого номера начинается индексация массива в JS?",
        opts: ["0", "1", "-1"],
        correct: 0,
        info: "Индексация массивов в JS начинается с 0."
    },
    {
        q: "Как добавить элемент в конец массива?",
        opts: ["array.add()", "array.push()", "array.append()"],
        correct: 1,
        info: "Метод push() добавляет элемент в конец массива."
    },
    {
        q: "Какой тег используется для создания нумерованного списка?",
        opts: ["&lt;ul&gt;", "&lt;ol&gt;", "&lt;li&gt;"],
        correct: 1,
        info: "&lt;ol&gt; (ordered list) создаёт нумерованный список."
    },
    {
        q: "Что делает метод querySelector()?",
        opts: ["Создаёт элемент", "Находит первый подходящий элемент", "Удаляет элемент"],
        correct: 1,
        info: "querySelector() находит первый элемент по CSS-селектору."
    },
    {
        q: "Какое ключевое слово используется для константы в JS?",
        opts: ["let", "var", "const"],
        correct: 2,
        info: "const объявляет константу, значение которой нельзя изменить."
    },
    {
        q: "Что означает alt у тега img?",
        opts: ["Альтернативный текст", "Высота картинки", "Ссылка на изображение"],
        correct: 0,
        info: "alt — альтернативный текст, если картинка не загрузится."
    },
    {
        q: "Какое событие срабатывает при клике на элемент?",
        opts: ["onMouseOver", "onClick", "onSubmit"],
        correct: 1,
        info: "Событие 'click' срабатывает при клике мыши."
    }
];
...
function checkAnswer() {
    ...
    opts.forEach(o => o.style.pointerEvents = 'none'); // Блокируем клики
